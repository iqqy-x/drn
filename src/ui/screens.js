export function createScreens(elements) {
  ...
  return {
    ...
    setCalibration(message, ready, showButton = true) { elements.calibrationState.textContent = message; elements.calibrationButton.hidden = !showButton; elements.calibrationButton.disabled = !ready; },
